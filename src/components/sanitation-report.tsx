    ...
    <Sheet open={open} onOpenChange={(isOpen) => {
      ...
      >
        <SheetHeader className="p-6 pb-2">
          <SheetTitle>Mapear Contentor</SheetTitle>
          <SheetDescription>
            Ajuste o pino no mapa para a localização exata do contentor de lixo. Adicione uma nota se necessário.
          </SheetDescription>
        </SheetHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
                ...
                render={({ field }) => (
                    ...
                    <FormControl>
                        <Textarea
                        placeholder="Ex: Contentor antigo, serve uma zona movimentada, etc."
                        {...field}
                        />
                    </FormControl>
                    <FormMessage />
            ...
            <SheetFooter className="p-6 pt-4 border-t bg-background">
                ...
                <Button type="submit">Mapear Contentor</Button>
            </SheetFooter>
          </form>
        </Form>
      </SheetContent>
