...
export const PointOfInterestUpdateSchema = z.object({
  ...
  authorId: z.string(),
  timestamp: z.string(),
  photoDataUri: z.string().optional(), // For proof of execution
});
...
export const PointOfInterestSchema = z.object({
  ...
  lastReported: z.string().optional(), // For ATMs and Sanitation
  authorId: z.string().optional(), // ID of the user who reported it
  updates: z.array(PointOfInterestUpdateSchema).optional(), // For Construction timeline & Sanitation proof
});
